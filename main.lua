...
function love.draw()
  ...
  for i,v in ipairs(player.bullet_shots) do
    love.graphics.draw(bullet.image, v.x, v.y, v.rotation)
  end

  love.graphics.setColor(237,20,90)
  for i,v in ipairs(player.flame_shots) do
    love.graphics.draw(player.bullet_image, v.x, v.y, v.rotation)
...
function shoot()
    if player.bullet_ammo > 0 and player.bullet_firing_rate_cur <= 0 then
        ...
        while times <= 0 and player.bullet_ammo > 0 do
            ...
            player.xvel = player.xvel - bullet.mass * math.cos(player.rotation)
            player.yvel = player.yvel - bullet.mass * math.sin(player.rotation)
